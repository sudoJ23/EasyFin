        ...
        slivers: [
          SliverAppBar(
            ...
            title: Center(
              child: Text(
                "Profile",
                style: TextStyle(fontFamily: "Poppins", color: Colors.grey.shade800, fontSize: 16),
              ),
            ),
          ),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Text(
                          "Logout",
                          style: TextStyle(fontFamily: 'Poppins', color: Colors.red.shade600, fontWeight: FontWeight.w500),
                        ),
                      ),
                    )
                  ],
